 ...
 */
class LoadResetPasswordControllerData extends AbstractFixture implements FixtureInterface, OrderedFixtureInterface
{
    /**
     * {@inheritDoc}
     */
    public function load(ObjectManager $manager)
    {
        ...
        $user->setUsername('Reset Password Controller User');
        $user->setEmail('reset-password-controller-user@example.com');
